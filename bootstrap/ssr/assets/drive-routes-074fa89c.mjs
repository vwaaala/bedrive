...
import { r as queryClient, aD as getFromLocalStorage, aE as setInLocalStorage, a9 as getBootstrapData, a as apiClient, s as showHttpErrorToast, m as message, t as toast, aF as useAuth, ab as MenuTrigger, d as IconButton, av as KeyboardArrowDownIcon, ac as Menu, I as Item, T as Trans, L as Tooltip, B as Button, b as useIsMobileMediaQuery, aG as Navbar$1, ao as FileTypeIcon, k as useTrans, x as SvgImage, aH as secureFilesSvg, l as TextField, aI as getAxiosErrorMessage, ag as prettyBytes, aJ as useFileUploadStore, u as useSettings, aK as getActiveWorkspaceId, aL as UploadedFile, aM as openUploadWindow, K as FormattedDate, i as Checkbox, a3 as ProgressCircle, aN as AdHost, o as opacityAnimation, j as DialogTrigger, $ as Section, a1 as FileUploadProvider, w as IllustratedMessage, aC as NotFoundPage, aO as ProgressBarBase, aP as WorkspaceQueryKeys, z as onFormQueryError, f as useDialogContext, D as Dialog, g as DialogHeader, h as DialogBody, F as Form, E as FormTextField, y as DialogFooter, aQ as useActiveWorkspaceId, aR as PersonalWorkspace, v as ConfirmationDialog, V as useValueLists, aS as ExitToAppIcon, H as CloseIcon, A as ArrowDropDownIcon, R as ButtonBase, aT as useUserWorkspaces, aU as useActiveWorkspace, aV as openDialog, G as CheckIcon, Q as createEventHandler, a4 as useNavigate$1, aW as CustomMenuItem, C as CustomMenu, aX as shallowEqual, n as SearchIcon, aY as ContextMenu, aZ as useMediaQuery, a0 as MixedText, a_ as ErrorIcon, au as WarningIcon, a$ as CheckCircleIcon, a8 as SiteConfigContext, b0 as ComboBoxForwardRef, X as List, Y as ListItem, q as StaticPageTitle, aB as AuthRoute } from "../server-entry.mjs";
...
import { R as useFileEntryUrls, j as downloadFileFromUrl, k as FileDownloadIcon, V as FileThumbnail, L as LinkIcon, x as DeleteIcon, W as TableContext, M as MoreVertIcon, T as Table, H as FilePreviewDialog, D as DashboardLayout, a as DashboardNavbar, c as DashboardContent, X as FilePreviewContainer, Y as FileEntryUrlsContext, y as ChipField, P as UnfoldMoreIcon, A as AddIcon, v as useDroppable, t as useDraggable, Z as FILE_ENTRY_TYPE_FILTER, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, _ as DashboardLayoutContext, i as FilterList, s as droppables, p as usePointerEvents, w as updateRects, $ as activeInteraction, a0 as isCtrlOrShiftPressed, a1 as isCtrlKeyPressed, l as Avatar, E as useNormalizedModels, q as Switch, n as FormSwitch, m as FormDatePicker, Q as ArrowBackIcon, a2 as dragMonitors, b as DashboardSidenav } from "./UnfoldMore-39cfd8ca.mjs";
import { I as ImportExportIcon, R as RemoveRedEyeIcon, P as PersonAddIcon, S as StarIcon, a as StarOutlineIcon, D as DriveFileMoveIcon, b as DriveFileRenameOutlineIcon, C as ContentCopyIcon, c as RestoreIcon, d as CreateNewFolderIcon, F as FileUploadIcon, e as DriveFolderUploadIcon, f as DeleteForeverIcon, g as SortIcon, G as GridViewIcon, h as StorageIcon, i as GroupIcon, A as ArrowRightIcon, B as BackupIcon, j as FolderIcon, U as UploadFileIcon, k as GroupsIcon, V as ViewListIcon, l as ViewModuleIcon, m as InfoIcon } from "./Info-9a52876e.mjs";
import { AnimatePresence, m } from "framer-motion";
import clsx from "clsx";
import memoize from "nano-memoize";
import { enableMapSet } from "immer";
import { B as Breadcrumb, a as BreadcrumbItem, E as EditIcon, C as ChevronRightIcon } from "./Edit-0bb552cc.mjs";
...
function useMakeCopyAction(entries) {
  ...
  return {
    ...
    key: "makeCopy",
    execute: () => {
      duplicateEntries2.mutate({ entryIds: entries.map((e) => e.id) });
      driveState().selectEntries([]);
    }
  };
}
...
function EntryActionMenuTrigger({ children, entries, page }) {
  if ((page == null ? void 0 : page.id) === RootFolderPage.id) {
            ...
            Button,
            {
              onClick: async (e) => {
                ...
                if (workspaceId) {
                  ...
                  onChange == null ? void 0 : onChange(workspaceId);
                }
              },
              variant: "outline",
...
const setActiveFolder = (response) => {
  ...
  if (newFolder && currentPage && currentPage.id === newFolder.hash && // only update page if once to set the folder or if permissions change, to keep page reference as stable as possible
...
function usePaginatedEntries() {
  ...
  const params = {
    ...
    folderId: (page == null ? void 0 : page.isFolderPage) ? page.id : null,
    workspaceId,
    ...sortDescriptor
  };
        ...
        children: items.map((item, index) => {
          ...
          return /* @__PURE__ */ jsx(BreadcrumbItem, { children: ({ isMenuItem }) => {
            ...
            return /* @__PURE__ */ jsx(EntryActionMenuTrigger, { page: item.page, children: /* @__PURE__ */ jsxs(ButtonBase, { className: "flex items-center gap-2 rounded focus-visible:ring-offset-4", children: [
              ...
              /* @__PURE__ */ jsx(ArrowDropDownIcon, { className: "icon-md text-muted" })
            ] }) });
          } }, item.page.id);
        })
      }
...
function useRootItem() {
  ...
  if (workspace && !workspace.default) {
    if ((page == null ? void 0 : page.isFolderPage) && ((page == null ? void 0 : page.id) === RootFolderPage.id || ((_a2 = page.folder) == null ? void 0 : _a2.workspace_id) === workspace.id)) {
...
//# sourceMappingURL=drive-routes-074fa89c.mjs.map
